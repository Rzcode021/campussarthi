...
from .views import CrewListView, SubmitRatingView, MyRatingsView, PlacementFamilyListView, CrewRecentFeedbacksView
...
urlpatterns = [
    ...
    path('<int:crew_id>/feedbacks/', CrewRecentFeedbacksView.as_view(), name='crew-recent-feedbacks'),
]
